...
const Genre = () => {
  return (
    <section className="relative flex flex-col justify-center items-center text-white bg-black space-y-5 border-t border-gray-600 py-8 px-10">
      <div className="text-white w-full flex items-center justify-between px-10 py-2">
        <div className="font-mono uppercase text-lg text-white">Genres</div>
      ...
      <div className="w-full overflow-x-auto scrollbar-none rounded-sm">
        ...
        <div className="flex flex-nowrap justify-start items-center space-x-2">
          ...
          {genres.map((genre, index) => (
            <div
              key={index}
              className="bg-black w-80 flex-shrink-0 border border-gray-500 hover:border-white overflow-hidden"
              style={{
